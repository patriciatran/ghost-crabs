...
```{r}
data <- read.csv("all-burrows-2018.csv", header=TRUE)
...
hist(Dunes$Area, ylim=c(0,100), xlim=c(0,5000))

hist(Beach$Area, ylim=c(0,100),xlim=c(0,5000))
...
barplot(counts.of.orientation, ylim = c(0,150), main="Orienation of the burrows by environment type",
